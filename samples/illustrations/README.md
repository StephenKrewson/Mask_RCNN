...
Make and document changes to balloon example. Run the balloon example, follow the convention for storing weights in top level and datasets in dataset dir. Get it working with MobaXTerm to ballpark how long it will take on Grace HPC.
